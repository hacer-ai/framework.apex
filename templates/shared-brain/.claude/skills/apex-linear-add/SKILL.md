...
1. Determine the next T-NNN number from TASKS.md (scan for the highest existing number, use +1)
...
If the Linear MCP is not connected, still add the task to TASKS.md (without the [LIN] tag)
and tell the user Linear was skipped.
