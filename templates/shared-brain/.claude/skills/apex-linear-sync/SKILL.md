...
description: Sync a task status change to Linear. Use whenever a task in TASKS.md changes state — moving to In Progress, marking as Done, marking as Blocked, or unblocking. Trigger phrases: "mark done", "task complete", "starting task", "blocked on", "unblocked".
---
