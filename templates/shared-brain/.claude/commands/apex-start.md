...
Note HEAD hash (first 7 chars). If MAP.md has a "Last verified:" line with a different hash, mark as stale.
...
- TASKS.md > 400 lines → warn bloat, suggest running `/compact` to free context
