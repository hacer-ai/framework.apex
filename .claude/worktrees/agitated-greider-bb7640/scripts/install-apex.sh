...
FILES=(
  ...
  ".claude/commands/apex-sync.md"
  ".claude/commands/apex-tidy.md"
  ...
  ".agents/skills/apex-tidy/SKILL.md"
  ".agents/skills/apex-sync/SKILL.md"
  ".agents/skills/apex-sync/agents/openai.yaml"
